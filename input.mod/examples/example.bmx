...
Type TGame
	...
	' and when you want to update any given identifier, automagically, you just send the info off to the bind map and it will
	' do the rest).
	...
	Function UpdateBinds()
		If bind_update.GetStateHit()
			Try
				Local node:dNode = dScriptFormatter.LoadFromFile("binds.script")
				If node
