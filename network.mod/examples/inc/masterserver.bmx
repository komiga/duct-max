...
Type TMasterServer Extends dServer
	...
	Method Create:TMasterServer(socket:TSocket, port:Int, accept_timeout:Int)
		_init(New dNetMessageMap.Create(), socket, port, accept_timeout)
		m_msgmap.InsertMessage(New TPositionMessage.Create())
		m_opmessage = New TPlayerOperationMessage.Create()
		m_msgmap.InsertMessage(m_opmessage)
		m_movemessage = New TPlayerMoveMessage.Create()
